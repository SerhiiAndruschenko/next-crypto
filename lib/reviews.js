...
export async function getReview(slug) {
   const text = await readFile(`./content/articles/${slug}.md`, "utf8");
...
export const CACHE_TAG_REVIEWS = 'news';

const WORDPRESS_API_URL = "https://www.cms.cryptodigest.space/wp-json/custom/v1";
